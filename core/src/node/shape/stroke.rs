...
impl ConvertTo<Option<Stroke>> for Color {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Stroke>> for (Color, Real) {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Stroke>> for (Color, i32) {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Stroke>> for (Color, Real, f32) {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Stroke>> for (Color, i32, f32) {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Stroke>> for Gradient {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Stroke>> for (Gradient, Real) {
    fn convert(self) -> Option<Stroke> {
        Some(self.into())
    }
}
