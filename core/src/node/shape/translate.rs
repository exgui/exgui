use crate::node::{ConvertTo, Pct, Real, RealValue};
...
impl From<(i32, i32)> for Translate {
    fn from((x, y): (i32, i32)) -> Self {
        Translate {
            x: RealValue::px(x as Real),
            y: RealValue::px(y as Real),
        }
    }
}
...
impl ConvertTo<Option<Translate>> for (Real, Real) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (i32, i32) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (Pct<Real>, Real) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (Pct<i32>, Real) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (Real, Pct<Real>) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (Real, Pct<i32>) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (Pct<Real>, Pct<Real>) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}

impl ConvertTo<Option<Translate>> for (Pct<i32>, Pct<i32>) {
    fn convert(self) -> Option<Translate> {
        Some(self.into())
    }
}
